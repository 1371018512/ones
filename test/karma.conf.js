...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'ones/bower_components/chosen/chosen.jquery.js',
      'ones/bower_components/angular-chosen-localytics/dist/angular-chosen.js',
      ...
      'ones/bower_components/jsbarcode/dist/JsBarcode.all.min.js',
